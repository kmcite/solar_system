...
import 'package:solar_system/utils/bloc/transition.dart';
...
abstract class Bloc<Event, State> extends BlocBase<State>
  ...
  ///
  static EventTransformer<dynamic> transformer = (events, mapper) => events
      .map(mapper)
      .transform<dynamic>(
        const _FlatMapStreamTransformer<dynamic>(),
      );
