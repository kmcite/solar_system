...
class AddPanelDialog extends StatefulWidget {
  const AddPanelDialog({super.key});

  @override
  State<AddPanelDialog> createState() => _AddPanelDialogState();
}

class _AddPanelDialogState extends State<AddPanelDialog> {
  ...
  void _addPanel() {
    if (_formKey.currentState!.validate()) {
      ...
      context.read<PanelsRepositoryImpl>().addPanel(panel);
...
void showAddPanelDialog(BuildContext context) {
  showDialog(
    context: context,
    builder: (context) => const AddPanelDialog(),
  );
}
