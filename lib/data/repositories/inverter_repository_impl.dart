...
import '../../domain/repositories/inverter_repository_interface.dart';

/// Implementation of InverterRepository using in-memory storage
class InverterRepositoryImpl extends ChangeNotifier
    implements InverterRepositoryInterface {
